...
public class ReportReplyController {
    ...
    public String reportReplyModify(Model model, @PathVariable("id") Integer id, Principal principal) {
    ...
    public String reportReplyDelete(Principal principal, @PathVariable("id") Integer id) {
        ReportReply reportReply = this.reportReplyService.getReportReply(id);
        if (!reportReply.getUser().getUserId().equals(principal.getName())) {
    ...
    @GetMapping("/like/{id}")
    @ResponseBody
    public String reportReplyLike(Principal principal, @PathVariable("id") Integer id) {
        ReportReply reportReply = this.reportReplyService.getReportReply(id);
